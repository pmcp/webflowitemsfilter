...
<span style="margin-left:24px;margin-right:24px;">Pagina {{ activePage }} van {{ totalPages }}</span>
  ...
  mounted() {
    ...
    const container1 = document.getElementById("vueVideoItems_batch1");
    const container2 = document.getElementById("vueVideoItems_batch2");
    const itemsObject1 = container1.children;
